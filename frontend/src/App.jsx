...
import CreateCodingQuestion from './pages/Admin/CodingQuestions/CreateCodingQuestion';
            ...
            <Route path="/admin/*" element={
              <ProtectedRoute requiredRole="admin">
                <Routes>
                  ...
                  <Route path="coding-questions/create" element={<CreateCodingQuestion />} />
                  <Route path="coding-questions/edit/:id" element={<CreateCodingQuestion />} />
